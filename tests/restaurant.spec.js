...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    // ```
    assert.strictEqual(typeof createMenu.createMenu(createMenu.objTest), 'object');
    ...
    // ```
    assert.deepEqual(Object.keys(createMenu.createMenu(createMenu.objTest).fetchMenu), ['food', 'drink']);
    ...
    // ```
    assert.deepEqual(createMenu.createMenu(createMenu.objTest).fetchMenu, createMenu.objTest);
    ...
    // ```
    assert.deepEqual(createMenu.createMenu(createMenu.objTest).consumption, []);
    ...
    assert.deepEqual(createMenu.restaurant.consumption, ['coxinha', 'agua', 'sopa', 'sashimi']);
    ...
    createMenu.orderFromMenu('coxinha');
    assert.deepEqual(createMenu.restaurant.consumption, ['coxinha', 'agua', 'sopa', 'sashimi', 'coxinha']);
    // ```
    ...
    createMenu.restaurant.consumption = [];
    // console.log(createMenu.restaurant);
    createMenu.orderFromMenu('coxinha');
    createMenu.orderFromMenu('agua');
    createMenu.orderFromMenu('coxinha');
    // console.log(createMenu.restaurant.consumption);
    assert.strictEqual(createMenu.restaurant.pay(), 11.7);
  });
});
