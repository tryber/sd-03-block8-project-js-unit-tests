...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    assert.deepEqual(createMenu({ food: {}, drink: {} }), {
      fetchMenu: {
        food: {}, drink: {}
      }
    });
    ...
    assert.strictEqual(createMenu({ food: {}, drink: {} }).consumption, []);
    // ```
    // const objetoRetornado = createMenu(objetoQualquer);
    ...
    assert.strictEqual(createMenu({ food: {}, drink: {} }).order('coxinha'), createMenu({ food: {}, drink: {} }).consumption === ['coxinha']);
    // ```;
    // const objetoRetornado = createMenu(objetoQualquer);
