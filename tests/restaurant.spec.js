...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    // ```
    assert.deepEqual(objetoRetornado.fetchMenu, { food: { coxinha: 3.90, sanduiche: 9.90 }, drinks: { agua: 2.90, cerveja: 6.90 } });
    ...
    // ```
    assert.deepEqual(objetoRetornado.fetchMenu, meuRestaurante);
    ...
    objetoRetornado.order('coxinha');
    objetoRetornado.order('sashimi');
    assert.deepEqual(objetoRetornado.consumption, ['coxinha', 'agua', 'coxinha', 'sashimi']);
    ...
    objetoRetornado.order('agua');
    objetoRetornado.order('coxinha');
    assert.equal(objetoRetornado.pay(), 25.960000000000004);
