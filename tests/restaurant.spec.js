...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    // ```
    assert.deepEqual(createMenu({'coxinha': 3.9, 'sopa': 9.9}).menu, {fetchMenu:{'coxinha': 3.9, 'sopa': 9.9}});
    ...
    // ```
    assert.deepStrictEqual(createMenu({ food: {}, drink: {}}).menu.fetchMenu, { food: {}, drink: {}});
    ...
    // ```
    assert.deepStrictEqual(createMenu({'coxinha': 3.9, 'sopa': 9.9}).menu.fetchMenu, {'coxinha': 3.9, 'sopa': 9.9});
    ...
    // ```
    assert.deepStrictEqual(createMenu({'coxinha': 3.9, 'sopa': 9.9}).consumption, []);
    ...
    // ```
    const fatorDeTest = createMenu();
    fatorDeTest.order("coxinha");
    assert.deepStrictEqual(fatorDeTest.consumption, ["coxinha"]);
    ...
    // ```
    fatorDeTest.order("agua");
    fatorDeTest.order("sopa");
    fatorDeTest.order("sashimi");
    assert.deepStrictEqual(fatorDeTest.consumption, ["coxinha", "agua", "sopa", "sashimi"]);
    ...
    // ```
    fatorDeTest.order("coxinha");
    assert.deepStrictEqual(fatorDeTest.consumption, ["coxinha", "agua", "sopa", "sashimi", "coxinha"]);  
    ...
    // ```
    fatorDeTest.menu.fetchMenu = { food: {'coxinha': 3.9, 'sopa': 9.9 , 'sashimi': 1.5 }, drink: {'agua': 3.9, 'cerveja': 6.9} }
    assert.strictEqual(fatorDeTest.pay(), 23.1)
