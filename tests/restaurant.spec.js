...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    assert.equal(createMenu({}), { fetchMenu: {} });
    ...
    assert.equal(objetoRetornado.fetchMenu, { food: {}, drink: {}, });
    ...
    assert.equal(objetoRetornado.consumption, []);
    // const objetoRetornado = createMenu(objetoQualquer);
    ...
    assert.equal(objetoRetornado.order("coxinha"), objetoRetornado.consumption);
    // const objetoRetornado = createMenu(objetoQualquer);
