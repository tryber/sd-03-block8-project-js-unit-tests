...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    // ```
    assert.strictEqual(typeof createMenu({food: {'coxinha': 3.90, 'sanduiche': 9.90,}, drinks: {'agua': 3.90, 'cerveja': 6.90}}), 'object');
    ...
    // ```
    let menuteste = createMenu({ food: {}, drink: {} });
    assert.deepEqual(menuteste.fetchMenu, { food: {}, drink: {} } );
    // const objetoRetornado = createMenu(objetoQualquer);
    ...
    let ordertest = createMenu(menuteste);
    ordertest.order('coxinha');
    assert.deepEqual(ordertest.consumption, ['coxinha'])
    // const objetoRetornado = createMenu(objetoQualquer);
    ...
    ordertest.order('sopa');
    ordertest.order('sashimi');
    assert.deepEqual(ordertest.consumption, ['coxinha', 'agua', 'sopa', 'sashimi']);
    ...
    // ```
    ordertest.order('coxinha');
    assert.deepEqual(ordertest.consumption, ['coxinha', 'agua', 'sopa', 'sashimi', 'coxinha']);
