...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    assert.deepEqual(Object.keys(objectResult.fetchMenu), ['food', 'drinks'])
    ...
    assert.deepEqual(objectResult.consumption, [])
    ...
    // ```
    objectResult.order('coxinha');
    assert.deepEqual(objectResult.consumption, ['coxinha']);
    ...
    objectResult.order("agua");
    objectResult.order("sopa");
    objectResult.order("sashimi");

    assert.deepEqual(objectResult.consumption, ["coxinha", "agua", "sopa", "sashimi"]);
    ...
    assert.deepEqual(objectResult.consumption, ['coxinha', 'agua', 'coxinha']);
    ...
    // ```
    assert.equal(objectResult.pay(menu), 12.87);
