...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    // // ```
    // assert.deepEqual(createMenu({}), { fetchMenu: {} })
    ...
    // // --------------------------------------------------------------------------------------
    // // TESTE 3: Verifique que o menu passado pra função createMenu 
    ...
    // // ```
    // assert.deepEqual(createMenu({}).consumption, [])
    ...
    // // ```
    // assert.deepEqual(orderFromMenu(coxinha).consumption, ['coxinha'])
    ...
    // // ```
    // assert.deepEqual(restaurant.consumption.length, 3);
    ...
    // // ```
    // assert.deepEqual(restaurant.consumption, ['coxinha', 'agua', 'coxinha']);
    ...
    // // ```
    // assert.strictEqual(restaurant.pay(), 11.7);
