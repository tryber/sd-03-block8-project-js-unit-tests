...
describe('#productDetails', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    assert.notEqual(productDetails(firstProduct, secondProduct)[0].details.productId.indexOf('123'), -1);
    assert.notEqual(productDetails(firstProduct, secondProduct)[1].details.productId.indexOf('123'), -1);
  });
});
